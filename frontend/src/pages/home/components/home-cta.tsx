...
export default function HomeCta() {
  return (
    <section className="container pb-28">
      <motion.div
        {...fadeUp}
        className="relative rounded-[2rem] bg-gradient-primary p-12 md:p-20 text-primary-foreground overflow-hidden"
      >
        <div className="absolute inset-0 grid-bg opacity-20" />
        <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-accent/40 blur-3xl" />
        <div className="relative max-w-2xl">
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight">
            Your next <span className="font-serif italic font-normal">&quot;aha!&quot;</span> moment
            is one tap away.
          </h2>
